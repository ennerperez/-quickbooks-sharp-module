...
using QuickBooks.Abstractions.Models;
...
namespace QuickBooks.Services
{
    public class QuickBooksService
    {
        ...
        public QuickBooksService(IOptionsMonitor<Options> optionsMonitor, HttpClient httpClient, ILoggerFactory loggerFactory) //, Utf8JsonSerializer jsonSerializer
        {
        ...
        public void SetHttpClient(bool isPdf = false)
        {
            ...
            _httpClient.DefaultRequestHeaders.Add("authorization", string.Format(CultureInfo.InvariantCulture, "oauthtoken {0}", AuthToken));
        }
